...
public class ItemCompraListProducer implements Serializable {
	...
	public List<ItemCompra> findCompraPendenteOrderByData(Empresa empresa, Integer compraId) {
        ...
        Predicate[] predicates = getSearchPredicates(root, empresa, compraId);
	...
	private Predicate[] getSearchPredicates(Root<ItemCompra> root, Empresa empresa, Integer compraId) {
